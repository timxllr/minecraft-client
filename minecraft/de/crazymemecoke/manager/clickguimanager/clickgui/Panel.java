...
public class Panel {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Client.main().setMgr().settingByName("Design", Client.main().modMgr().getByName("ClickGUI")).getMode().equalsIgnoreCase("New")) {
        ...
        } else if (Client.main().setMgr().settingByName("Design", Client.main().modMgr().getByName("ClickGUI")).getMode().equalsIgnoreCase("JellyLike")) {
        ...
        } else if (Client.main().setMgr().settingByName("Design", Client.main().modMgr().getByName("ClickGUI")).getMode().equalsIgnoreCase("Ambien")) {
        ...
        if (this.extended && !Elements.isEmpty()) {
            ...
            int epanelcolor = Client.main().setMgr().settingByName("Design", Client.main().modMgr().getByName("ClickGUI")).getMode().equalsIgnoreCase("New") ? 0xff232323 : Client.main().setMgr().settingByName("Design", Client.main().modMgr().getByName("ClickGUI")).getMode().equalsIgnoreCase("JellyLike") ? 0xbb151515 : 0;

            for (ModuleButton et : Elements) {
                if (Client.main().setMgr().settingByName("Design", Client.main().modMgr().getByName("ClickGUI")).getMode().equalsIgnoreCase("New")) {
                    RenderUtils.drawRect(x - 2, startY, x + width, startY + et.height + 1, outlineColor);
                }
                if (Client.main().setMgr().settingByName("Design", Client.main().modMgr().getByName("ClickGUI")).getMode().equalsIgnoreCase("Ambien")) {
