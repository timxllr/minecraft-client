    ...
    public void drawTextBox() {
        if(this.getVisible()) {
            if(this.getEnableBackgroundDrawing()) {
                RenderUtils.drawBorderedRect(this.xPosition, this.yPosition, (this.xPosition + this.width), (this.yPosition + this.height), 0.7F, this.isFocused?Colors.DARKBLUE.c:Colors.GREY.c, 0);
            }
            ...
            if(s.length() > 0) {
                ...
                j1 = (int)this.fontRendererInstance.drawString(flag2, l, i1, -1);
            }
            ...
            if(s.length() > 0 && flag && j < s.length()) {
                var10000 = (int)this.fontRendererInstance.drawString(s.substring(j), j1, i1, -1);
            }
            ...
            if(flag1) {
                if(var13) {
                    ...
                    this.fontRendererInstance.drawString("_", k1, i1, -1);
                }
            }

            if(k != j) {
                int l1 = l + this.fontRendererInstance.getStringWidth(s.substring(0, k));
                drawRect(k1, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, RenderUtils.reAlpha(Colors.DARKBLUE.c, 0.3F));
            }
        }
