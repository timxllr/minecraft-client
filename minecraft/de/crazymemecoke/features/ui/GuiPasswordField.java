...
public final class GuiPasswordField extends Gui {
   ...
   public void drawTextBox() {
      if(this.func_146176_q()) {
         ...
         if(var4.length() > 0) {
            ...
            var9 = this.field_146211_a.drawString(var13.replaceAll(".", "*"), var7, var8, var1);
         }
   ...
   private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
      ...
      var2.pos(p_146188_1_, p_146188_4_, 0.0D);
      var2.pos(p_146188_3_, p_146188_4_, 0.0D);
      var2.pos(p_146188_3_, p_146188_2_, 0.0D);
      var2.pos(p_146188_1_, p_146188_2_, 0.0D);
