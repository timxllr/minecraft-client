...
public class GuiEditAlt extends GuiScreen {
    ...
    public void drawScreen(int posX, int posY, float f) {
        ...
        Client.main().fontMgr().comfortaa20.drawString("EDIT ALT", width / 2 - Client.main().fontMgr().comfortaa20.getStringWidth("EDIT ALT") / 2, height / 2 - 140, Colors.main().getGrey());
