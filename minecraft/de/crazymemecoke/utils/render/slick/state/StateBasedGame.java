...
import de.crazymemecoke.utils.render.slick.Game;
...
public abstract class StateBasedGame implements Game, InputListener {
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.Game#closeRequested()
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.Game#getTitle()
	 */
