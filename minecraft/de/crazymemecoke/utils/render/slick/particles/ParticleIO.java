package de.crazymemecoke.utils.render.slick.particles;
...
import de.crazymemecoke.utils.render.slick.particles.ConfigurableEmitter.ColorRecord;
import de.crazymemecoke.utils.render.slick.particles.ConfigurableEmitter.LinearInterpolator;
import de.crazymemecoke.utils.render.slick.particles.ConfigurableEmitter.RandomValue;
import de.crazymemecoke.utils.render.slick.particles.ConfigurableEmitter.SimpleValue;
...
public class ParticleIO {
   ...
   public static ParticleSystem loadConfiguredSystem(InputStream ref,
		...
		try {
         ...
         if (system == null) {
         system = new ParticleSystem("de/crazymemecoke/utils/render/slick/data/particle.tga",
					2000, mask);
         }
