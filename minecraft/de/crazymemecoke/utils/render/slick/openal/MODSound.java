package de.crazymemecoke.utils.render.slick.openal;
...
public class MODSound extends AudioImpl {
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.openal.AudioImpl#playAsMusic(float, float, boolean)
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.openal.AudioImpl#playAsSoundEffect(float, float, boolean)
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.openal.AudioImpl#stop()
	 */
	public void stop() {
		store.setMOD(null);
	}
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.openal.AudioImpl#getPosition()
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.openal.AudioImpl#setPosition(float)
	 */
