...
public class OggInputStream extends InputStream implements AudioInputStream {
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.openal.AudioInputStream#getChannels()
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.openal.AudioInputStream#getRate()
	 */
	public int getRate() {
		return -1;
	}
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.openal.AudioInputStream#atEnd()
	 */
