package de.crazymemecoke.utils.render.slick.opengl.pbuffer;
...
import de.crazymemecoke.utils.render.slick.opengl.InternalTextureLoader;
...
public class PBufferUniqueGraphics extends Graphics {
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.Graphics#disable()
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.Graphics#enable()
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.Graphics#destroy()
	 */
	public void destroy() {
		super.destroy();
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.Graphics#flush()
	 */
	public void flush() {
		super.flush();
