...
import de.crazymemecoke.utils.render.slick.Sound;
...
public class MouseOverArea extends AbstractComponent {
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.gui.AbstractComponent#render(GUIContext,
	 *      de.crazymemecoke.utils.render.slick.Graphics)
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.util.InputAdapter#mouseMoved(int, int, int, int)
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.util.InputAdapter#mouseDragged(int, int, int, int)
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.util.InputAdapter#mousePressed(int, int, int)
	 */
	...
	/**
	 * @see de.crazymemecoke.utils.render.slick.util.InputAdapter#mouseReleased(int, int, int)
	 */
