...
public class ScalableGame implements Game {
	...
	/**
	 * @see BasicGame#init(de.crazymemecoke.utils.render.slick.GameContainer)
	 */
	...
	/**
	 * @see BasicGame#update(de.crazymemecoke.utils.render.slick.GameContainer, int)
	 */
	...
	/**
	 * @see Game#render(de.crazymemecoke.utils.render.slick.GameContainer, Graphics)
	 */
