...
public class Fucker extends Module {
    ...
    public Fucker() {
        ...
        options.add("Eggs");
        options.add("Cakes");
        Client.getInstance().getSetmgr().rSetting(new Setting("Fucker Mode", this, "Beds", options));
    }

    @Override
    public void onUpdate() {
        String mode = Client.getInstance().getSetmgr().getSettingByName("Fucker Mode", this).getValString();
        if (getState()) {
