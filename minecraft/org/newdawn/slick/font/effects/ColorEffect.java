...
public class ColorEffect implements ConfigurableEffect {
	...
	/**
	 * @see Effect#draw(BufferedImage, Graphics2D, org.newdawn.slick.UnicodeFont, org.newdawn.slick.font.Glyph)
	 */
	...
	/**
	 * @see org.newdawn.slick.font.effects.ConfigurableEffect#setValues(List)
	 */
