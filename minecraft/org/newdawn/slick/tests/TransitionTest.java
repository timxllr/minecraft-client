...
public class TransitionTest extends StateBasedGame {
	...
	/**
	 * @see StateBasedGame#initStatesList(org.newdawn.slick.GameContainer)
	 */
	...
	private class ImageState extends BasicGameState {
		...
		/**
		 * @see org.newdawn.slick.state.GameState#init(org.newdawn.slick.GameContainer, StateBasedGame)
		 */
		...
		/**
		 * @see org.newdawn.slick.state.GameState#render(org.newdawn.slick.GameContainer, StateBasedGame, org.newdawn.slick.Graphics)
		 */
		...
		/**
		 * @see org.newdawn.slick.state.GameState#update(org.newdawn.slick.GameContainer, StateBasedGame, int)
		 */
